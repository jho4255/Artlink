      ...
      {user && (
        <div className="mt-16 pt-6 border-t border-gray-100 flex justify-end">
          <button
            ...
            className="text-xs text-gray-400 hover:text-accent transition-colors cursor-pointer"
          >
            회원 탈퇴
          </button>
        </div>
                    ...
                    <div className="pl-[4.5rem] pr-4 pb-4">
                      ...
                      {isAdmin && (
                        <div className="flex justify-end gap-2 mt-2">
                          ...
                          <button onClick={() => deleteMutation.mutate(faq.id)} className="text-xs text-gray-400 hover:text-accent flex items-center gap-1">
                            <Trash2 size={12} /> 삭제
                          </button>
                        </div>
                      )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`flex-none text-xs font-medium ${
                      inq.status === 'ANSWERED' ? 'text-gray-500' : 'text-accent'
                    }`}>
