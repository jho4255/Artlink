export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <p className="text-sm text-gray-400 mb-10">최종 수정일: 2026년 6월 21일</p>
      ...
      <div className="space-y-10 text-gray-700 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">3. 보관 기간</h2>
          <ul className="list-disc list-inside space-y-1 text-gray-600">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">4. 제3자 제공</h2>
