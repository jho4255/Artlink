...
LIMITS = {'grain_abs': ('range', (5.0, 15.0), '매트 종이 결(절대 std). 골든 6.4(검정)~13.5(흰색)'),
          'dir_abs': ('range', (5.0, 34.0), '매트 위↔아래 밝기차(절대). 골든 6.7(흰)~31.6(검정)'),
          'bevel_abs': ('range', (8.0, 45.0), '개구부 45° 사면의 밝기 낙차(절대)'),
