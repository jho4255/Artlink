...
async function main() {
  ...
  const faqData = [
    { order: 0, question: 'ArtLink는 어떤 서비스인가요?', answer: 'ArtLink는 갤러리와 아티스트를 연결하는 매칭 플랫폼입니다.\n갤러리는 공모전·전시를 등록하고 아티스트를 모집할 수 있으며, 아티스트는 포트폴리오를 등록하고 원하는 공모에 직접 지원할 수 있습니다.' },
    { order: 1, question: '회원가입은 어떻게 하나요?', answer: '카카오 계정으로 간편하게 가입할 수 있습니다.\n로그인 페이지에서 "카카오로 시작하기"를 클릭한 후, 역할(아티스트 또는 갤러리)과 연락처를 입력하면 가입이 완료됩니다.' },
    { order: 2, question: '아티스트와 갤러리 계정의 차이가 무엇인가요?', answer: '아티스트 계정은 포트폴리오 등록, 공모 지원, 갤러리 리뷰 작성, 찜하기 기능을 사용할 수 있습니다.\n갤러리 계정은 갤러리 등록, 공모·전시 등록, 지원자 관리, Instagram 피드 연동 기능을 사용할 수 있습니다.' },
    { order: 3, question: '포트폴리오는 어떻게 등록하나요?', answer: '로그인 후 마이페이지 > 포트폴리오 섹션에서 등록할 수 있습니다.\n작가 약력, 전시 이력(개인전·단체전·아트페어), 작품 사진(최대 30장)을 입력하면 됩니다.\n등록된 포트폴리오는 공모 지원 시 갤러리 담당자에게 자동으로 전달됩니다.' },
    { order: 4, question: '공모에 지원하면 어떻게 되나요?', answer: '공모 상세 페이지에서 "지원하기" 버튼을 클릭하면 갤러리 담당자에게 포트폴리오가 전달됩니다.\n지원 후 상태는 마이페이지 > 지원 내역에서 확인할 수 있으며, 접수 → 검토중 → 수락/거절 순서로 변경됩니다.' },
    { order: 5, question: '지원한 공모의 결과는 어디서 확인하나요?', answer: '마이페이지 > 지원 내역 탭에서 확인할 수 있습니다.\n전체/접수/검토중/수락/거절 탭으로 필터링할 수 있으며, 각 카드를 클릭하면 내가 제출한 답변 내용도 확인할 수 있습니다.' },
    { order: 6, question: '갤러리 등록은 어떻게 하나요?', answer: '갤러리 계정으로 로그인 후 마이페이지 > 갤러리 등록에서 신청할 수 있습니다.\n갤러리명, 주소, 소개, 대표자명, 전화번호, 대표 이미지, 지역을 입력하고 승인 요청을 하면 운영팀 검토 후 승인됩니다.\n승인 완료 후 갤러리 찾기 페이지에 노출됩니다.' },
    { order: 7, question: '공모 등록 시 승인이 필요한가요?', answer: '네, 갤러리와 공모 모두 운영팀의 승인 후 플랫폼에 노출됩니다.\n승인까지 보통 1~3 영업일이 소요되며, 거절 시 사유를 확인하고 마이페이지에서 재등록할 수 있습니다.' },
    { order: 8, question: '승인된 갤러리 정보를 수정하고 싶어요.', answer: '승인 후에는 갤러리 소개(상세 설명) 수정만 직접 가능합니다.\n갤러리명, 주소 등 기본 정보 수정이 필요한 경우 마이페이지에서 수정 요청을 통해 운영팀에 문의해 주세요.' },
    { order: 9, question: 'Instagram 피드를 갤러리 페이지에 연동할 수 있나요?', answer: '네, 갤러리 계정의 마이페이지에서 Instagram 연동 기능을 사용할 수 있습니다.\nInstagram OAuth를 통해 연동하면 갤러리 상세 페이지에 최신 게시물이 자동으로 표시됩니다.\nInstagram 비즈니스 또는 크리에이터 계정이 필요합니다.' },
    { order: 10, question: '찜한 갤러리와 공모는 어디서 확인하나요?', answer: '마이페이지 > 찜 목록 탭에서 확인할 수 있습니다.\n갤러리와 공모가 구분되어 표시되며, 찜 취소 시 목록에서 즉시 제거됩니다.' },
    { order: 11, question: '갤러리 리뷰는 누가 작성할 수 있나요?', answer: '아티스트 계정으로 로그인한 경우 갤러리 상세 페이지에서 리뷰를 작성할 수 있습니다.\n별점과 텍스트를 입력할 수 있으며, 익명으로 작성하면 "익명의 예술가"로 표시됩니다.\n본인이 작성한 리뷰는 마이페이지 > 활동 내역에서 수정·삭제할 수 있습니다.' },
    { order: 12, question: '알림은 어떤 경우에 오나요?', answer: '다음과 같은 경우에 알림이 발송됩니다.\n· 갤러리/공모 승인 또는 거절 시\n· 지원한 공모의 상태 변경 시 (검토중·수락·거절)\n· 1:1 쪽지 수신 시\n알림은 상단 네비게이션의 벨 아이콘에서 확인할 수 있습니다.' },
    { order: 13, question: '갤러리에 직접 메시지를 보낼 수 있나요?', answer: '네, 갤러리 상세 페이지 또는 공모 상세 페이지에서 쪽지 보내기 기능을 사용할 수 있습니다.\n마이페이지 > 쪽지함에서 주고받은 메시지를 확인할 수 있습니다.' },
    { order: 14, question: '지원자 목록을 엑셀로 다운로드할 수 있나요?', answer: '네, 갤러리 계정의 마이페이지 > 공모 관리에서 지원자 목록을 CSV 파일로 다운로드할 수 있습니다.\n이름, 이메일, 지원일, 상태, 커스텀 답변 내용이 포함됩니다.' },
    { order: 15, question: '공모에 추가 질문 항목을 설정할 수 있나요?', answer: '네, 공모 등록 시 지원자에게 추가로 받을 정보를 직접 설정할 수 있습니다.\n텍스트 입력, 단일/복수 선택형, 파일 업로드 등 다양한 형식의 항목을 추가할 수 있습니다.' },
    { order: 16, question: '혜택 페이지에는 어떤 내용이 있나요?', answer: 'ArtLink와 제휴한 미술 관련 서비스·브랜드의 특별 혜택 정보를 제공합니다.\n재료 할인, 작업실 대여, 프린팅 서비스 등 아티스트 활동에 도움이 되는 다양한 혜택을 확인해 보세요.' },
    { order: 17, question: '문의는 어떻게 하나요?', answer: '고객센터 페이지의 1:1 문의 탭에서 문의를 남기실 수 있습니다.\n로그인 후 제목과 내용을 입력하면 운영팀이 검토 후 답변을 등록해 드립니다.\n긴급한 문의는 하단 연락처로 직접 연락해 주세요.' },
  ];
